...
class AI_Application_Design(QMainWindow):
    ...
    def insert_supervised_model(self, model):
        ...
        id, family, alg_type, name, binary, reg, bio, related, parameters, ploting, import_path, playground, C, alpha, degree, criterion, n_estimators, learning_rate, gamma, n_clusters, eps, min_samples = model
        def reveal_model(model_data):
            ...
            id, family, alg_type, name, binary, reg, bio, related, parameters, ploting, import_path, playground, C, alpha, degree, criterion, n_estimators, learning_rate, gamma, n_clusters, eps, min_samples = model_data
